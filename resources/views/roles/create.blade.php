            ...
            <div class="col-xl-6">
                <div class="card height-equal">
                    <div class="card-body custom-input">
                        <form class="row g-3" action="{{route('admin.roles.store', [], false)}}" method="post" onsubmit="disableSubmitBtn()">
                            @csrf
                            <div class="col-12">
                                <label class="form-label" for="role-name">{{__('Role Name')}} <span class="text-danger">*</span></label>
                                <input class="form-control" id="role-name" name="role_name" type="text" placeholder="eg. Admin" value="{{old('role_name')}}" aria-label="Role Name" required="">
                            </div>
                            <div class="col-12">
                                <div class="form-check checkbox checkbox-dark mb-0">
                                    <input class="form-check-input" id="checkbox-primary-admin-login" type="checkbox" name="is_admin_login_allowed" value="1">
